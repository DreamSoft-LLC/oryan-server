...
type Transaction struct {
	...
	AssociateID primitive.ObjectID `json:"associate_id" bson:"associate_id"` //	Associate initiating purchase
	Kind        string             `json:"kind" bson:"kind"`                 // Kind Sell or buy
	Weight      float64            `json:"weight" bson:"weight"`             //	Weight of the mineral
	Mineral     string             `json:"mineral" bson:"mineral"`           // Mineral gold or diamond
	Rate        float64            `json:"rate" bson:"rate"`                 // Rate buying rate
	Amount      float64            `json:"amount" bson:"amount"`             // Amount money given to seller
...
type Customer struct {
	...
	Number      string             `json:"number" bson:"number"`           // Unique number for the customer
	IDNumber    string             `json:"id_number" bson:"id_number"`     // ID number of the customer
	Phone       string             `json:"phone" bson:"phone"`             // Phone number of the customer
	Email       string             `json:"email" bson:"email"`             // Email address of the customer
